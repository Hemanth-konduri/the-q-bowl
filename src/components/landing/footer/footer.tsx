...
export default function Footer() {
  return (
    <footer className="bg-[#E5A00D] text-black pt-12 pb-10 relative overflow-hidden">
      ...
      <div className="w-full overflow-hidden border-y-4 border-black bg-black py-3 text-[#E5A00D] font-mouse-memoirs text-2xl sm:text-3xl font-bold tracking-widest uppercase mb-12 shadow-[0_4px_0_#000000]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center my-6 py-4 overflow-hidden">
          <h1 className="font-mouse-memoirs text-[22vw] sm:text-[24vw] leading-[0.72] text-black font-black uppercase tracking-tighter select-none transition-transform duration-700 hover:scale-[1.02] inline-block animate-hero-floating cursor-pointer">
            THE Q BOWL
          </h1>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="p-8 bg-black text-[#f5e3cd] rounded-[2rem] border-4 border-black shadow-[6px_6px_0px_#000000] flex flex-col justify-between">
            ...
            <div className="pt-6">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black border-2 border-[#E5A00D] text-[#E5A00D] font-sans text-xs font-bold uppercase tracking-wider">
          ...
          <div className="p-8 bg-black text-[#f5e3cd] rounded-[2rem] border-4 border-black shadow-[6px_6px_0px_#000000]">
            ...
            <div>
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-2">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-black border-2 border-[#E5A00D]/40 text-[#FFF8EE] placeholder-[#f5e3cd]/50 text-xs font-sans focus:outline-none focus:border-[#E5A00D]"
                />
                <button
                  type="submit"
                  className="w-full py-3 rounded-xl bg-[#E5A00D] text-black font-outfit text-xs font-extrabold uppercase tracking-wider hover:bg-white transition-colors flex items-center justify-center gap-2 shadow-[2px_2px_0px_#000]"
                >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 border-t-4 border-black">
            ...
            {[
              ...
              return (
                <a
                  key={idx}
                  href={s.href}
                  className="p-3 rounded-full bg-black text-[#E5A00D] border-2 border-black hover:bg-white hover:text-black transition-all transform hover:scale-110 shadow-[3px_3px_0px_#000000]"
                  aria-label={s.label}
                >
        ...
        <div className="mt-8 pt-6 border-t-2 border-black/20 flex flex-col sm:flex-row items-center justify-between text-xs font-sans text-black font-medium gap-4">
