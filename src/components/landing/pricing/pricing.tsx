...
export default function Pricing() {
  ...
  return (
    <section id="subscriptions" data-nav-dark="false" className="py-24 bg-[#f5e3cd] text-[#1B4D3E] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Section Header */}
        <div className="gsap-reveal text-center max-w-3xl mx-auto mb-14">
          <span className="font-mouse-memoirs text-2xl text-[#1B4D3E] uppercase font-bold tracking-widest block mb-2">
            FLEXIBLE MEAL SUBSCRIPTIONS
          </span>
          <h2 className="font-outfit text-4xl sm:text-6xl font-extrabold text-[#1B4D3E] uppercase tracking-tight leading-none">
            EAT WELL ON YOUR TERMS
          </h2>
          <p className="font-sans text-base sm:text-lg text-[#1B4D3E]/80 mt-3 font-normal">
            Pause or skip any meal before cutoff. Skipped meals extend your plan automatically.
          </p>
        </div>

        {/* Core Subscription Rule Banner */}
        <div className="gsap-reveal max-w-4xl mx-auto mb-12 retro-card p-6 sm:p-8 bg-[#FFF8EE] border-2 border-[#1B4D3E] flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            <div className="p-3.5 rounded-2xl bg-[#1B4D3E] text-[#E5A00D] shrink-0 border-2 border-[#1B4D3E]">
              <Calendar className="w-7 h-7" />
            </div>
            <div>
              <h4 className="font-outfit text-2xl font-bold text-[#1B4D3E]">
                The 1 Meal = 1 Subscription Day Guarantee
              </h4>
              <p className="font-sans text-xs sm:text-sm text-[#1B4D3E]/80 mt-1 leading-relaxed">
          ...
          <div className="shrink-0 text-center md:text-right border-t md:border-t-0 md:border-l-2 border-[#1B4D3E]/20 pt-4 md:pt-0 md:pl-6">
            <span className="font-outfit text-base font-bold text-[#1B4D3E] block">100% Pause Flexibility</span>
            <span className="font-sans text-xs text-[#1B4D3E]/70 font-medium">Extend End Date Anytime</span>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Controls */}
          <div className="gsap-reveal lg:col-span-7 retro-card p-8 bg-white border-2 border-[#1B4D3E]/20 space-y-8">
            <div>
              <h3 className="font-outfit text-2xl font-bold text-[#1B4D3E] uppercase">Build Your Custom Plan</h3>
              <p className="font-sans text-xs text-[#1B4D3E]/70 mt-1 font-medium">Select plan duration and preferred daily meal slots.</p>
            </div>

            {/* Duration Selector */}
            <div>
              <label className="font-outfit text-xs font-bold uppercase tracking-wider text-[#1B4D3E] block mb-3">
                ...
                {([7, 15, 30] as const).map((d) => (
                  <button
                    ...
                    className={`p-4 rounded-2xl border-2 transition-all ${
                      duration === d
                        ? "bg-[#1B4D3E] border-[#1B4D3E] text-white shadow-[4px_4px_0px_#0F3329]"
                        : "bg-[#FFF8EE] border-[#1B4D3E] text-[#1B4D3E] hover:bg-[#E5A00D]/20"
                    }`}
                  >
            ...
            {/* Included Advantages */}
            <div className="pt-4 border-t-2 border-[#1B4D3E]/20 space-y-2.5">
              <div className="flex items-center gap-3 font-sans text-xs text-[#1B4D3E] font-medium">
          ...
          {/* Price Summary Card */}
          <div className="gsap-reveal lg:col-span-5 retro-card-dark p-8 border-4 border-[#E5A00D] flex flex-col justify-between h-full bg-[#0F3329]">
            <div>
              ...
              <div className="bg-[#1B4D3E] p-4 rounded-xl border border-[#E5A00D]/40 space-y-2 mb-6 font-sans text-xs">
            ...
            <div className="space-y-3">
              <Link
                href="/register"
                className="w-full py-3.5 rounded-full font-outfit font-bold text-base text-[#0F3329] bg-[#E5A00D] hover:bg-white transition text-center block uppercase shadow-[4px_4px_0px_#000]"
              >
                Subscribe Now
              </Link>
