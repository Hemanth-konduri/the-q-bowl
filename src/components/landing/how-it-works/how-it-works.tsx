    ...
    <section id="how-it-works" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="gsap-reveal text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-black border border-zinc-800 text-[#94A39B] mb-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {STEPS.map((step, idx) => {
            ...
            return (
              <div
                key={step.number}
                className="gsap-reveal glass-panel p-8 rounded-3xl border border-zinc-800 hover:border-zinc-700 transition-all duration-300 relative group flex flex-col justify-between"
              >
                <div>
                  {/* Step Number & Icon */}
                  <div className="flex items-center justify-between mb-8">
                    <span className="font-display text-5xl font-black text-zinc-800 group-hover:text-zinc-600 transition-colors">
                      {step.number}
                    </span>
                    <div className="p-3.5 rounded-2xl bg-black text-white border border-zinc-800">
                ...
                <div className="mt-6 pt-4 border-t border-zinc-800/40 flex items-center gap-2 text-[10px] uppercase font-bold tracking-wider text-white opacity-0 group-hover:opacity-100 transition-opacity">
