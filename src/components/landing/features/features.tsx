    ...
    <section className="py-20 bg-[#F7F3E8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl font-bold mb-4" style={{ color: "#000000" }}>Why choose Q1 Bowl?</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((f, i) => (
            <div key={i} className="p-6 rounded-2xl bg-white border" style={{ borderColor: "#E8E4D9" }}>
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4" style={{ background: "#000000" }}>
                <f.icon size={24} color="#FFFFFF" />
              </div>
              <h3 className="text-lg font-semibold mb-2" style={{ color: "#000000" }}>{f.title}</h3>
