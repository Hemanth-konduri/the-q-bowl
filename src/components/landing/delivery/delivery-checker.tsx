          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-6">
              ...
              {result && (
                <div className="mt-4 transition-all">
                  {result.found && result.area ? (
                    <div className="p-4 rounded-xl bg-zinc-100 border-2 border-black flex items-center gap-3 text-black font-sans text-xs">
              ...
              <div className="mt-6 pt-4 border-t-2 border-black/20">
                <span className="font-sans text-xs text-black/70 uppercase font-bold block mb-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {SUPPORTED_AREAS.slice(0, 5).map((a) => (
                    <button
                      ...
                      className="px-3 py-1 rounded-full bg-[#FFF8EE] border border-black font-sans text-xs font-semibold text-black hover:bg-black hover:text-white transition"
                    >
                      {a.name} ({a.pincode})
                    </button>
                  ))}
