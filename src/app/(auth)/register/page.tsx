    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="w-full max-w-md">
          {step === "details" ? (
            <>
              <h1 className="text-2xl font-bold mb-1 text-center" style={{ color: "#24332B" }}>Create your account</h1>
              <p className="text-sm text-center mb-8" style={{ color: "#7C817A" }}>
                Already have an account?{" "}
                <Link href="/login" className="font-semibold hover:underline" style={{ color: "#496A5A" }}>Sign in</Link>
              </p>
              ...
              <div className="space-y-3 mb-4">
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: "#24332B" }}>Full name <span style={{ color: "#D86F45" }}>*</span></label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: "#24332B" }}>Phone number</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: "#24332B" }}>Email address <span style={{ color: "#D86F45" }}>*</span></label>
                  <input
                    type="email"
            ...
            <>
              <h1 className="text-2xl font-bold mb-1 text-center" style={{ color: "#24332B" }}>Verify your email</h1>
              <p className="text-sm text-center mb-8" style={{ color: "#7C817A" }}>
